      ...
      <div className="flex flex-col gap-8 xl:flex-row xxl:items-start">
        <Card className="shadow-none w-[290px] mx-auto">
          ...
          >
            ...
            >
              <AiFillCamera size={30} className="mx-auto text-moonstone" />
            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-12/12 px-1">
                <div className="relative w-full mb-3">
                  ...
                  <textarea
                    type="text"
                    className="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 rounded text-sm focus:outline-none focus:ring w-full ease-linear transition-all duration-150 outline-none shadow-none border-[1px] border-gray-200 bg-whitesmoke font-medium font-inter resize-none focus:bg-transparent focus:border-moonstone"
                    rows="4"
                    value={profile?.bio}
                    name="bio"
