    ...
    <Menu placement="bottom-end">
      <MenuHandler>
        <div className="flex items-center gap-x-[14px] cursor-pointer">
          <div className={`font-inter uppercase text-sm ${location.pathname.startsWith("/admin") ? "text-dark-blue capitalize hidden md:block": "tracking-[1px]"}`}>
      ...
      <MenuList>
        ...
        <Link to="/admin/account" className={`outline-none border-none ${!location.pathname.startsWith("/admin") && "hidden"}`}>
          <MenuItem className="flex items-center gap-2">
