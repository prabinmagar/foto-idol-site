...
import { AiOutlineDashboard, AiOutlineGroup, AiOutlineShareAlt, AiOutlineUser } from "react-icons/ai";
...
export const ContentSidebar = () => {
  ...
  return (
    <>
      <div className={`content-sidebar-overlay ${sidebarOverlayClass}`} onClick={handleOverlayClick}></div>
      <div
          ...
          <List className="px-3">
            ...
            <ListItem className="p-0">
              <Link
                to="/admin/images"
                className={`flex p-4 w-full ${
                  location.pathname === "/admin/images" ? "active-link" : ""
                }`}
              >
                <ListItemPrefix className="w-[20px] flex items-center justify-start">
            ...
            {/* <ListItem className="p-0">
              ...
              >
                <ListItemPrefix className="w-[20px] flex items-center justify-start">
                  <AiOutlineUnorderedList className="scale-125" />
                </ListItemPrefix>
                Category
              </Link>
            </ListItem> */}
            ...
            <ListItem className="p-0">
              <Link
                ...
                className={`flex p-4 w-full ${
                  location.pathname === "/admin/social_links" ? "active-link" : ""
                }`}
              >
                <ListItemPrefix className="w-[20px] flex items-center justify-start">
