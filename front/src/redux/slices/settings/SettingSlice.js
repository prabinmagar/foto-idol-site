...
export const toggleHomeFeature = createAsyncThunk("features/list", async (resourceId, thunkAPI) => {
  try {
...
export const getFeaturesLists = createAsyncThunk("features-get/list", async (_, thunkAPI) => {
  try {
...
export const createOrUpdateContactInfo = createAsyncThunk("contact/list", async (formdata, thunkAPI) => {
  try {
...
export const getContactInfo = createAsyncThunk("contact-get/list", async (_, thunkAPI) => {
  try {
