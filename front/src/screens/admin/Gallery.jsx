...
export const GalleryItem = (props) => {
  ...
  return (
    <article className="bg-white rounded-lg p-1 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 cursor-pointer">
      <div onClick={onOpenClick}>
        ...
        <div className="mt-1 p-1 flex items-end flex-wrap gap-x-2">
          <Typography className="font-inter font-semibold text-sm capitalize">
            {props?.post?.user?.name}
          </Typography>
          <p className="text-dark-moonstone font-inter text-xs">
